...
$your_name = "Hensiruk" ; // test data with problematic characters
// $your_name = ""; // test data
...
<label>
<span><?php   ('Your   name',   'test');   ?></span> <!--   error in php syntax: missing ">"   -->
...
printf( ( '2: We have %d apples!', 'test' ), $apples ); // alternative 1
echo   "1: We   have   " .( $apples,   'test') . " apples!"; // alternative 2: may also work, but 1 is better
